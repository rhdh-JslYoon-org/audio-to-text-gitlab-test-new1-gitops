...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test-new1, stored in [quay.io/rh-ee-lyoon-dh/audio-to-text-gitlab-test-new1](https://quay.io/rh-ee-lyoon-dh/audio-to-text-gitlab-test-new1) and deployed through ArgoCD. 
